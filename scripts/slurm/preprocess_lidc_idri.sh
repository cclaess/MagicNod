...
apptainer exec --nv --bind $MOUNT_PATH --env-file ./.env $CONTAINER_PATH \
    python3 -u scripts/preprocess_lidc_idri.py \
        	--data-dir "/gpfs/work4/0/tese0618/Datasets/LIDC-IDRI/LIDC-IDRI" \
            --output-dir "/gpfs/work4/0/tese0618/Projects/MagicNod/data/LIDC-IDRI"